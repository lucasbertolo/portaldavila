...
var Select = function Select(props) {
  ...
  console.log(options); //   const selectOptions = options.split(', ');
  // eslint-disable-next-line max-len
  //   const selectOptionsList = selectOptions.map((selectOption, index) => <option key={`${keyid}-${index}`} value={index}>{selectOption}</option>);
...
//# sourceMappingURL=areauser.js.87c6afda72f90e08163d.hot-update.js.map